...
* Running the models : setting model parameters, splitting the norm_data into train and test, optionally pushing clinical subjects into the test set, and using with the runner tool of the pcntoolkit to submit estimation jobs to a cluster
