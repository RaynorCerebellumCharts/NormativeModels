...
This repository includes all code used for the estimation of voxelwise normative models of volumetry across the whole brain, and for the application of these estimated models to samples of interest (subject born preterm and patients with spinocerebellar ataxia). The corresponding manuscript is available at (https://www.biorxiv.org/content/10.64898/2026.03.27.714738v1-0) and models are available at (https://surfdrive.surf.nl/s/Mb6mZyFmJeCaPcZ). The pcntoolkit general documentation is available at (https://pcntoolkit.readthedocs.io/en/stable/).
...
This was run on python 3.12 with pcntoolkit v1.3.0 (for additional python dependencies, cf. conda virtual environment yml file).
